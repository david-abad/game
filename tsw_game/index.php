<?php
 ...
 require_once('App/Auth/valRegistro.php');
	...
	<div class="modal-dialog text-center">
		<div class="col-md-12 main-section">
			...
			<div class = "modal-content main-section">
                ...
                <a href="juego.html" class="btn  btn-foursquare btn-lg text-center">JUGAR</a>
                <span></span>
               ...
               <?php else: ?>
				...
				<form class="col-8" method="post">
					...
					<p></p>
					 ...
					 <input href=juego.html name="btnEnviar" class="btn  btn-foursquare btn-lg text-center" type="submit" value="Login"/>
